...
namespace FF_Network_
{
    public partial class frmCustomer : Form
    {
        ...
        private void frmCustomer_Load(object sender, EventArgs e)
        {
            ...
            //mtxtCreatedDate.Mask = "00/00/0000";
            //mtxtCreatedDate.ValidatingType = typeof(System.DateTime);
            //mtxtCreatedDate.TypeValidationCompleted += new TypeValidationEventHandler(mtxtCreatedDate_TypeValidationCompleted);
            //mtxtCreatedDate.KeyDown += new KeyEventHandler(mtxtCreatedDate_KeyDown);
        ...
        private void btnOk_Click(object sender, EventArgs e)
        {
            ...
            if (CustomerController.IsValidReferenceMemberID(txtIntroducerID.Text))
            {
                MessageBox.Show("Maximum level reached for this memebership id !!", "FF Network", MessageBoxButtons.OK, MessageBoxIcon.Information);
                txtIntroducerID.Focus();
                return;
            }
            //---------------------------------------------------------------------------------------------------------------------
        ...
        private void navigation(int pRowIndex)
        {
            if (lstCustomer.Count > 0)
            {
                if (pRowIndex >= 0 && pRowIndex < lstCustomer.Count)
                {
                    ...
                    //if (lstCustomersType[pCurrentRow].Name != null)
                    //{
                    //    if (pRowIndex >= 0 && pRowIndex < lstCustomersType.Count)
                    //    {
                    //        ddlCustomerType.Text = lstCustomersType[pRowIndex].Name.ToString();
                    //    }
                    //}
        ...
        //private void mtxtCreatedDate_TypeValidationCompleted(object sender, TypeValidationEventArgs e)
        //{
        //    DateTime rs;
        ...
        //        toolTip1.Show("We're sorry, but the value you entered is not a valid date. Please change the value.", mtxtDOB, 5000);
        //        // mtxtDOB.Text = "";
        //        e.Cancel = true;
        //        mtxtDOB.Focus();
        ...
        //    // System.Text.RegularExpressions.Regex rtime
        //    //       = new System.Text.RegularExpressions.Regex(@"(0[1-9]|[12][0-9]|3[01])[- /.](0[1-9]|1[012])[- /.](19|20)\d\d");
        //    //if (!rtime.IsMatch(mtxtDOB.Text))
        //    //{
        //    //    toolTip1.ToolTipTitle = "Invalid Date Value";
        //    //    toolTip1.Show("We're sorry, but the value you entered is not a valid date. Please change the value.", mtxtDOB, 5000);
        //    //    // mtxtDOB.Text = "";
        ...
        //    //    toolTip1.Show("The data you supplied must be a valid date in the format dd/MM/yyyy.", mtxtCreatedDate, 0, -20, 5000);
        //    //}
        //    //else
        //    //{
        ...
        //    //    {
        //    //        toolTip1.ToolTipTitle = "Invalid Date";
        //    //        toolTip1.Show("The date in this field must be greater than today's date.", mtxtCreatedDate, 0, -20, 5000);
        //    //        e.Cancel = true;
        //    //    }
        //    //}
